...
function LeadSearchPanel() {
  ...
  return (
    <div className="grid grid-cols-1 2xl:grid-cols-[330px_minmax(0,1fr)_360px] gap-6">
      <form
      ...
      <div className="bg-zinc-950 border border-zinc-800 rounded-3xl overflow-hidden min-w-0">
        ...
        <div className="divide-y divide-zinc-800 max-h-[650px] overflow-y-auto">
          {results.length === 0 ? (
            ...
            results.map((item) => (
              <div
                ...
                className={`p-5 flex gap-4 hover:bg-zinc-900/50 cursor-pointer min-w-0 ${
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="text-[#B6F24A] text-sm truncate">
                        {item.website || "No website found"}
                      </p>
                    </div>

                    <span className="rounded-full border border-zinc-700 px-3 py-1 text-sm font-bold shrink-0">
      ...
      <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-6 h-fit min-w-0">
        {!activeLead ? (
          ...
          <div className="space-y-5">
            <div className="min-w-0">
              <p className="text-[#B6F24A] text-sm truncate">
                {activeLead.website || "No website found"}
              </p>

              <h2 className="text-2xl font-black mt-1 break-words">
                {activeLead.businessName || "Unnamed Business"}
              </h2>
            ...
            <div className="rounded-2xl border border-zinc-800 bg-black p-4">
              ...
              <p className="text-zinc-300 text-sm leading-relaxed">
                {activeLead.reason || "No reason provided."}
              </p>
            </div>
...
function WebsiteRatingPanel() {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[380px_minmax(0,1fr)] gap-6">
      ...
      <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-6 min-w-0">
        {!report ? (
          <div className="text-zinc-500">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-black p-4">
              ...
              <p className="text-[#B6F24A] font-mono mt-1 break-all">
